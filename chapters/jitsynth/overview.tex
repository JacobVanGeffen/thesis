...
\lstinputlisting[language=rosette,xleftmargin=-.5em,firstline=1,basicstyle=\scriptsize\ttfamily]{code/toy-inputs.rkt}%multicols=2,numbers=left,numbersep=.75em,
\end{minipage}}
\vspace{-.5em}
...
outer loop):\tighten
\lstinputlisting[language=C,xleftmargin=2em,firstline=1,basicstyle=\scriptsize\ttfamily]{code/toy-compiler.c}%multicols=2,numbers=left,numbersep=.75em,
