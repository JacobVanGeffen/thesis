...
\paragraph{Attempting graph search with a \tord solver.}
...
in the theory of ordering consistency (\tord)\todo{cite}
...
% TODO elaborate on \tord

% TODO present results
Intuitively, % TODO discuss why this didn't work
...
%Specifically, we choose a variable whose corresponding 
...
Ultimately, % TODO chose log n vars such that the most edges were eliminated
